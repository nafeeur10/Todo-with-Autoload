<li v-for="(todo,index) in completed" :key="todo.index" v-if="completedTodo===true" class="pt-3 pb-3 border-li" @mouseover="showByIndex = index" @mouseout="showByIndex = null">
